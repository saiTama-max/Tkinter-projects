...
button_op_add = Button(root, text="+", padx=39, pady=20, command=button_add_num)
button_equal = Button(root, text="=", padx=88, pady=20, command=button_equal_num)
button_clear = Button(root, text="Clear", padx=79, pady=20, command=button_clear)
button_op_sub = Button(root, text="-", padx=41, pady=20, command=button_sub_num)
button_op_mul = Button(root, text="*", padx=40, pady=20, command=button_mul_num)
button_op_div = Button(root, text="/", padx=40, pady=20, command=button_div_num)
...
button_op_add.grid(row=5, column=0)
button_equal.grid(row=5, column=1, columnspan=2)
button_clear.grid(row=4, column=1, columnspan=2)
button_op_sub.grid(row=6, column=0)
button_op_mul.grid(row=6, column=1)
button_op_div.grid(row=6, column=2)
